...
<%--                    </div>--%>
                ...
                <div class="FAQ">
                    ...
                    <div class="FAQ-section">
                        <div class="suitable">
                            ...
                            <p>This course is VERY suitable for people who are completely unfamiliar with HTML and CSS (Academy's design focuses on newbies). You only need to know how to use a computer at a basic level to participate in the class.</p>
                    ...
                    <div class="FAQ-section">
                        <div class="benenfit">
                            ...
                            <p>With the videos you have learned, you can freely watch any video you want, with no limit on the number of times you watch the video. Academy even encourages you to watch as much as possible to better grasp your knowledge.</p>
                    ...
                    <div class="FAQ-section">
                        <div class="application">
                            ...
                            <p>Sure! Academy always focuses on students and goes hand in hand with practice. Therefore, after each video or text lesson, you will do a lot of exercises to condense your knowledge, master the syntax, and even do a new coding challenge.</p>
                    ...
                    <div class="FAQ-section">
                        <div class="support">
                            ...
                            <p>At each lesson at Academy, you can always ask questions, discuss and interact with your classmates.</p>
                            <p>In addition, Academy support specialists will always enthusiastically guide you if you encounter difficulties.</p>
    ...
    <div class="modal fade" id="exampleModalToggle" aria-hidden="true" aria-labelledby="exampleModalToggleLabel" tabindex="-1">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalToggleLabel" style="color: #000; font-weight: 500;">ATTENTION!!!</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                ...
                <div class="modal-footer">
                    <button class="btn-primary btnModalBuyCourse btnModalBuyCourse__Close" data-bs-dismiss="modal">Close</button>
                    <button class="btn-secondary btnModalBuyCourse btnModalBuyCourse__Buy" data-bs-dismiss="modal" data-bs-target="#exampleModalToggle2" data-bs-toggle="modal">Buy</button>
...
<%--    Day la modal khi mua khoa hoc that bai vi thieu tien--%>
    <div class="modal fade modalFail" id="exampleModalToggle2" aria-hidden="true" aria-labelledby="exampleModalToggleLabel2" tabindex="-1">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalToggleLabel2" style="color: #000; font-weight: 500;"><i class="fa-regular fa-bell"></i>Notification</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    Not enough money
                ...
                <div class="modal-footer">
                    <button class="btn-secondary btnModalBuyCourse btnModalBuyCourse__Close" data-bs-dismiss="modal">Close</button>
                    <button type="button" class=" btn-primary  btnModalBuyCourse" style="background: linear-gradient(to right, #ef3e0f, #ffb800);">
...
<%--    <div aria-live="polite" aria-atomic="true" style="position: relative; min-height: 200px;">--%>
        <div class="toast successNotification" style="position: fixed; top: 12rem; right: 0;" data-autohide=true data-delay="10000">
