            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <a href="/delete-comment-of-post?blogid=<%=post.getId()%>&id=<%=comment.getId()%>"
        ...
        <div class="modal fade modal__update" id="modal__update-commment_<%=comment.getId()%>">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <form action="/update-comment-of-post" method="post">
                        <div class="modal-body">
                            <input name="id" value="<%=comment.getId()%>" hidden="hidden">
                            <input name="postid" value="<%=post.getId()%>" hidden="hidden">
